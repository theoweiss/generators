...
openhab_common.py: Common Library for generation of openHAB bindings configuration and documentation
...
class OpenhabDevice(common.Device):
    def get_openhab_device_name(self):
    ...
    def get_openhab_class_name(self):
        return self.get_name().camel + self.get_category().camel

class OpenhabPacket(common.Packet):
    def get_python_name(self, skip=0):
        return self.get_name(skip).under
    def get_openhab_name(self, skip=0):
        return self.get_name(skip).headless
